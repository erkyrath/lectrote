const class_ids_to_codes={window:0,stream:1,fileref:2,schannel:3,}
const argUint8={serialize:()=>0,}
const argUint32={serialize:()=>1,}
...
this.retained_arrays.push({addr:data.addr,get arr(){return Array.from(arr)},arg:unicode?argUint32:argUint8,len:arr.length,objaddr:data.objaddr,origarr:arr,})
